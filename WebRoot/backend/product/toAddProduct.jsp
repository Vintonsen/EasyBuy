	...
	<div class="i_bg bg_color">
		...
		<div class="m_content">
			...
			<div class="m_right" id="content">
				...
				<br>
					<form action="${ctx}/admin/product?action=addProduct" method="post"
						...
						<table border="0" class="add_tab" style="width: 930px;"
							...
							<tr>
								...
								<td><c:if
										...
										<img src="${ctx}/files/${product.fileName}" width="50"
											height="50" />
									</c:if> <input type="file" class="text" name="photo" /><span></span>
								</td>
							</tr>
							<tr>
