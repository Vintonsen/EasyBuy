		...
		<table border="0" style="width: 1000px; text-align: center;"
			...
			<tr height="35">
				<td style="font-size: 18px;">感谢您在本店购物！您的订单已提交成功，请记住您的订单号: <font
					color="#ff4e00">${currentOrder.serialNumber}</font>
				</td>
			</tr>
			<tr>
				<td
			...
			<tr>
				<td style="padding: 20px 0 30px 0; font-family: '宋体';">
					收款人信息：全称 ${sessionScope.loginUser.userName} ；地址
					${currentOrder.userAddress} ； <br />
				</td>
			</tr>
			<tr>
				<td><a href="${ctx}/Home?action=index">首页</a> &nbsp; &nbsp; <a
					href="${ctx}/Home?action=index">用户中心</a></td>
			</tr>
		</table>
	</div>
</div>
